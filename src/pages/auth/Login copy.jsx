...
const Login = () => {
  return (
    // <form>
    //   <div className=''>
    //     <Input placeholder='Votre@email.com' type='email' handleChange={() => ('')} label='Email' />
    //   </div>
    // </form>
    ...
    //           <input
    //             type="text"
    //             className="peer block min-h-[auto] w-full rounded border border-gray-300 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:border-blue-300 focus:placeholder:opacity-100 peer-focus:text-blue-300 data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-black dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-blue-300 dark:focus:border-blue-300 [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0"
    //             id="exampleFormControlInput3"
    //             placeholder="Email address"
    //           />
    //           <label
    //             htmlFor="exampleFormControlInput3"
    //             className="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-blue-300 peer-data-[twe-input-state-active]:-translate-y-[1.15rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-blue-300"
    //           >
    //             Email address
    //           </label>
    //         </div>
    ...
    //             <input
    //               className="relative float-left -ms-[1.5rem] me-[6px] mt-[0.15rem] h-[1.125rem] w-[1.125rem] appearance-none rounded-[0.25rem] border-[0.125rem] border-solid border-secondary-500 outline-none checked:border-primary checked:bg-primary hover:cursor-pointer"
    //               type="checkbox"
    //               id="exampleCheck3"
    //             />
    //             <label
    ...
    //         >
    //           {/* Facebook */}
    //           <span className="me-2 fill-white">
    ...
    //               <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H11.3L233.5 192 62.4 48h136l109.7 148.3L389.2 48z" />
    //             </svg>
    //           </span>
