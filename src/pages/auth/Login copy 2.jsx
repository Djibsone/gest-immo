...
const Login = () => {
    return (
      // <section classNameName="h-full bg-neutral-200 dark:bg-neutral-700">
      //   <div classNameName="container h-full px-6 py-24">
      //     <div
      //       classNameName="flex h-full flex-wrap items-center justify-center lg:justify-between">
      //       {/* <!-- Left column container with background--> */}
      //       <div classNameName="mb-12 md:mb-0 md:w-8/12 lg:w-6/12">
      //         <img
      ...
      //       <div classNameName="md:w-8/12 lg:ms-6 lg:w-5/12">
      //         <form>
      //           {/* <!-- Email input --> */}
      ...
      //               type="email"
      //               name="email"
      //               classNameName="block w-full p-2 border border-gray-300 rounded-md"
      //               handleChange={() => ('')}
      //               label="Email address"
      //             />
      //           </div>
      ...
      //             <Link to={'forgot-password'} classNameName="text-primary focus:outline-none dark:text-primary-400">
      //                 Forgot password?
      //             </Link>
      //           </div>
      ...
      //           <button
      //             type="submit"
      //             classNameName="inline-block w-full rounded bg-blue-400 px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-white shadow-blue-300 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-blue-300 focus:shadow-blue-200 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-black"
